    ...
    <div class="col-ctn">
        ...
        <div class="col-left sidebar">
            <ul>
                ...
                <li>
                    <a href="help-3.jsp" id="title_3" class="active">留言基础操作</a>
                </li>
                <li>
        ...
        <div class="col-right" id="content_3" style="display:block;">
            <div class="table">
                ...
                <ul>
                    <li>
                        <a href="#3-1">3.1 发表新留言</a>
                    </li>
                    <li>
                        <a href="#3-2">3.2 对其它用户的留言发表评价</a>
                    </li>
                    <li>
                        <a href="#3-3">3.3 对官方给我的回复发表评价</a>
                    </li>
                    <li>
                        <a href="#3-4">3.4 编辑自己的留言</a>
                    </li>
                    <li>
            ...
            <div class="details">
                <div class="item">
                    ...
                    <h5>3.1 发表新留言</h5>
                    <ol>
                        <li>3.1.1 在《领导留言板》首页导航条选中“留言”按钮，进入留言页面，选中您所在的省市区，或者想要沟通的部委，并选择您希望沟通的领导姓名，进入相应版块后，即可进入留言界面。</li>
                        <li>3.1.2 点选《领导留言板》首页右上方的“给领导留言”按钮，进入留言页面，选中您的留言位置，发表新留言。</li>
                        <li>3.1.3 移动端用户登录，首页点击右上方“我要留言”按钮，或导航条中“留言”按钮，均可进入留言页面，选中您所希望沟通的领导姓名或直接选择“我要留言”，进入“给TA留言”界面直接进行留言或重选领导姓名发表留言。</li>
                        <li>3.1.4 小程序用户登录，直接点击左下方“留言”按钮，选择留言类别和所属领域，并选中留言版块，即可进行留言。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="3-2"></a>
                    <h5>3.2 对其它用户的留言发表评价 </h5>
                    <ol>
                        <li>《领导留言板》目前未开通游客或注册用户对其它网友留言进行评价的功能，现已开通注册用户对其它网友留言进行关注的功能，欢迎使用。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="3-3"></a>
                    ...
                    <ol>
                        <li>3.3.1 留言办理单位对留言做出回复后，留言用户登录后可以点击留言正文后“评价”按钮，对办理的程度、速度和态度进行打分，选择后会综合算出满意度，如有情况补充，可选择文字描述。请您客观进行评价。</li>
                        <li>3.3.2 游客留言无法使用评价功能。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="3-4"></a>
                    <h5>3.4 编辑自己的留言</h5>
                    <ol>
                        <li>《领导留言板》目前未开通用户对留言内容进行二次编辑功能。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="3-5"></a>
                    ...
                    <ol>
                        ...
                        <li>3.5.2 发表新留言时上传图片步骤为：点击发布留言页面内“增加附件”按钮，在添加图片的右侧点击“+”号选择要上传图片的具体文件名，选中并确认后，系统会自动上传图片。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="3-6"></a>
                ...
                <div class="item">
                    ...
                    <ol>
                        ...
                        <li>3.8.2 登录之后点击右上角的用户名，即可进入《领导留言板》的用户中心，看到“我的留言”等个人信息菜单项，点击链接之后就可进入到用户信息版块，并可以完善个人资料和修改密码。</li>
                    </ol>
                </div>
            </div>
        </div>
