    ...
    <div class="col-ctn">
        ...
        <div class="col-right" id="content_6" style="display:block;">
            <div class="table">
                <h4>5 常见问题</h4>
                <ol>
                    <li><b>《领导留言板》为您搭建与领导沟通的桥梁，不干涉双方沟通结果。《领导留言板》会积极携手各方更好地解决问题，但作为非主管部门，《领导留言板》无法保证您的留言一定能获得公开展示（有关留言能否展示请参阅“2.3留言及评价涉及以下内容将无法获得公开展示”），也不保证您的留言能获得回复，亦不保证您的诉求一定能获得解决。</b></li>
                </ol>
                <ul>
                    <li>
                        <a href="#5-1">5.1 留言怎么没有展示？</a>
                    </li>
                    <li>
                        <a href="#5-2">5.2 留言怎么没有回复？</a>
                    </li>
                    <li>
                        <a href="#5-3">5.3 留言怎么进行修改？</a>
                    </li>
                </ul>
            </div>
            <div class="details">
                <div class="item">
                    ...
                    <h5>5.1 留言怎么没有展示？</h5>
                    <ol>
                        <li>《领导留言板》的留言处理需要时间，随着留言量的不断增加，我们将尽量在24小时内处理完留言，送达领导案头。如超过24小时未获得展示，可能由于留言内容中有《管理协议》中提到的无法展示的内容。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="5-2"></a>
                ...
                <div class="item">
                    ...
                    <h5>5.3 留言怎么进行修改？</h5>
                    <ol>
                        <li>您发送的每一封留言，我们都认为是真实有效的，所以便于留言的审核和后续的办理，留言提交后是不能修改的，您需要在提交留言时对所说的内容负责。</li>
                    </ol>
                </div>
            </div>
        </div>
