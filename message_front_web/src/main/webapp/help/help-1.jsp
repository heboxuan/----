        ...
        <div class="col-right" id="content_1" style="display:block;">
            <div class="table">
                <ol>
                    ...
                    <li>直接（包括但不限于下载、安装、使用《领导咨询板》客户端、小程序、网页版）,或通过各类方式（如RSS 源、站外 API引用）间接使用本平台服务和数据的行为，都将被视作您已了解并无条件接受本协议各项条款，包括人民网对本协议随时所做的任何修改。</li>
                </ol>
                <h4>1 新用户必读</h4>
                <ul>
                    <li>
            ...
            <div class="details">
                <div class="item">
                    ...
                    <ol>
                        ...
                        <li>1.1.2 如咨询办理单位需要开通回复账号，可开通机构用户账号（
                        ...
                        <li>1.1.3 如果您需要以企业名义发布涉及经营问题、营商环境提升方面的咨询，可以进行企业账号认证（
                ...
                <div class="item">
                    ...
                    <h5>1.2 撰写咨询</h5>
                    <ol>
                        <li>1.2.1 选取咨询给哪位领导，选择咨询的类型及其所属领域，填写标题和正文。</li>
                        <li>1.2.2 请使用中文简体字进行咨询。</li>
                        <li>1.2.3 正文中必须有逻辑清晰、要素齐备的文字描述。对于无文字描述或文字描述不清晰、不完整的咨询，本平台暂不支持。咨询形式除文字外，您还可以添加位置信息，以及有合法来源的图片、视频以辅助描述情况。</li>
                        <li>1.2.4 为便于办理单位及时与您取得联系，并进行办理，请提供请填写真实有效的联系方式，以及准确的当事人（个人、法人或非法人组织）名称，与咨询相关所必需的地址、事情经过、诉求等信息。<b>请尽量避免只是情绪性表达而无实质描述。</b></li>
                ...
                <div class="item">
                    ...
                    <h5>1.3 办理结果</h5>
                    <ol>
                        <li>1.3.1 办理机构收到您的咨询后，将按照您提供的信息进行核实、办理、回复。</li>
                        <li>1.3.2 根据您提供信息的详实程度、事项办理的难易程度，及是否有办理机构进行办理，具体回复时间无法估计，请耐心等待。</li>
                        <li>1.3.3 如有进展，会通过《领导咨询板》APP推送给您。您也可以通过微信小程序随时进行查阅。</li>
                        <li><b>1.3.4 在等待过程中，请不要就同一事项重复咨询。</b></li>
                    </ol>
                </div>
                <div class="item">
                    <a name="1-4"></a>
                    <h5>1.4 评价反馈</h5>
                    <ol>
                        <li>1.4.1 收到回复后，您可以对这条咨询的办理情况进行打分评价。<br/></li>
                        <li>1.4.2 您可以从解决程度、办理时间、办理态度三个方面进行打分，每一方面的打分都会不同程度地决定该咨询评价的总分。<br/></li>
                    </ol>
                </div>
                <div class="item">
                    <a name="1-5"></a>
