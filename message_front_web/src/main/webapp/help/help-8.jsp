        ...
        <div class="col-right" id="content_9" style="display:block;">
            <div class="table">
                ...
                <ol>
                    ...
                    <li>引言</li>
                    <li>【领导咨询板】是由【人民网股份有限公司】（以下简称“我们”）研发和运营的在线【群众工作综合性】平台。</li>
                    <li>我们深知个人信息（含个人敏感信息）对您的重要性，并会全力保护您的个人信息安全。同时，我们承诺将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。</li>
                    <li>本隐私政策（以下简称“本政策”）适用于【领导咨询板】的所有相关服务。在使用【领导咨询板】各项服务前，请您务必仔细阅读并透彻理解本政策，并做出您认为适当的选择。一旦你开始使用【领导咨询板】的各项服务，即表示您已充分理解并同意本政策。</li>
            ...
            <div class="details">
                <div class="item">
                    ...
                    <ol>
                        ...
                        <li style="margin-left: 2rem;"><b>(1) 在咨询服务中，为便于您反馈问题的解决，您需提供个人姓名、联系电话。因为办理核实情况的需要，该信息会向对应办理单位公开，任何时候都不会在互联网上公开。</b></li>
                        <li style="margin-left: 2rem;"><b>(2) 为了更精准的办理提交的咨询，我们会收集和使用您的定位信息并同步给对应咨询办理机构，以便更加高效地办理您的诉求。</b></li>
                        <li style="margin-left: 2rem;">(3) 为了方便您提供有利于咨询快速办理的素材，我们会使用您的相机和录音权限，当您在咨询时选择使用上传或拍摄照片或视频功能，我们需申请调用您的相机权限和录音权限，如果您拒绝调用，将无法在咨询时添加照片或视频附件，但不影响其他无需该权限的功能；为了保护您的隐私信息，您可在咨询时选择是否公开定位信息、照片或视频。如不公开，则仅对办理单位可见，不会在互联网上公开。</li>
                        <li style="margin-left: 2rem;">(4) 为展示您在咨询服务中所提问题的回复信息，我们会收集您在提交问题时的编号、提交对象、提交时间信息用于向您展示及便于您对所提问题进行管理；</li>
                        ...
                        <li style="margin-left: 2rem;">(12) 我的收藏：记录用户主动收藏的内容到后台，包括咨询和资讯数据</li>
                        <li style="margin-left: 2rem;">(13) 咨询提交：对于用户主动提交的咨询，会保存在后台。</li>
                        <li style="margin-left: 2rem;">(14) 咨询浏览：点击查看咨询、对咨询内容点赞，用于后台统计数据。</li>
                        <li style="margin-left: 2rem;">(15) 推送功能：我们会记录推送消息记录，方便您在app中查找未读的推送消息。</li>
                        <li style="margin-left: 2rem;">(16) 浏览历史：会记录用户的资讯或咨询详情的浏览历史，以便于用户可以第一时间知道当前文章是否已阅览过。</li>
                ...
                <div class="item">
                    ...
                    <ol>
                        ...
                        <li style="margin-left: 1rem;">3.与我们的关联公司共享：你的个人信息可能会与【领导咨询板】的关联公司共享。我们只会共享必要的个人信息，且受本隐私政策中所声明目的的约束。关联公司如要改变个人信息的处理目的，将再次征求你的授权同意；</li>
                ...
                <div class="item">
                    ...
                    <ol>
                        ...
                        <li>我们也提供注册帐号的注销，您可以登录领导咨询板APP-我的-设置-账号注销，进行账号注销操作。</li>
