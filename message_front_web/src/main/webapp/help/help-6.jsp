    ...
    <div class="col-ctn">
        ...
        <div class="col-left sidebar">
            <ul>
                ...
                <li>
                    <a href="help-6.jsp" id="title_7" class="active">留言如何迅速得到办理</a>
                </li>
                <li>
        ...
        <div class="col-right" id="content_7" style="display:block;">
            ...
            <div class="details">
                <div class="item">
                    ...
                    <h5>6.1 准确选择留言给谁</h5>
                    <ol>
                        <li>6.1.1 请选择诉求、咨询发生地的管理领导，跨省留言因为超出管理辖区将无法获得响应而耽误留言办理。</li>
                        <li>6.1.2 留言提交给精确的管辖地领导，有助缩短留言响应时间。如果无法确定响应地域，可以提交给上一级领导。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="6-2"></a>
                ...
                <div class="item">
                    ...
                    <ol>
                        ...
                        <li>6.3.2 请不要使用过于抽象的标题，如“请领导关注”“书记，求助”。精准的留言标题便于分类整理留言，缩短办理时间。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="6-4"></a>
                    <h5>6.4 选择客观事实撰写留言正文</h5>
                    <ol>
                        <li>6.4.1 请在正文开头直接写明诉求。</li>
                        <li>示例：“请疏通XX小区门口道路” “请降低XX小学课业负担”，相反如果写成“XX小区门口有大量黑车”“XX小学生晚上没有时间玩”则不利于留言办理，会增加办理时间。</li>
                        <li>6.4.2 正文诉求需包含以下要素：诉求的时间、原因、简要经过、涉及单位、涉及金额、造成的困难、影响程度以及期望的结果等。留言缺少必要的要素，可能无法获得平台展示，进而诉求无法得到响应。</li>
                        <li>6.4.3 请客观的描述事实。对于正文中涉及的个人隐私，如电话号码、姓名、家庭住址、证件号码等请写入备注区。正文中涉及到隐私信息可能会导致留言无法展示而不能得到办理。</li>
                        <li>6.4.4 需要写清当事各方的具体情况，不要有主观评价、侮辱、攻击性的言论，特别是没有事实根据的臆测。如“XX村长贪污”“可能有利益输出”，此类留言可能无法获得展示。</li>
                        <li><b>请尽量避免只是情绪性表达而无实质描述。</b></li>
                        <li>6.4.5 除以上要素外，留言描述尽量简明扼要，过多的修辞、宣泄会占用正文篇幅，增加办理机构的工作量，不利于诉求的尽快解决。</li>
                        <li>6.4.6 每条留言请只描述一个诉求，不要在一条留言中描述多个诉求，也不要把一个诉求拆分到多条留言，这都不利于留言的快速处理响应。</li>
                        <li>6.4.7 所有留言反映的情况及诉求都以正文里的文字为唯一依据，图片、视频、备注等仅为辅助内容，正文如无具体文字内容则无法办理。</li>
                    </ol>
                </div>
            </div>
        </div>
