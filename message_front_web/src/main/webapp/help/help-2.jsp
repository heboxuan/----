        ...
        <div class="col-right" id="content_2" style="display:block;">
            <div class="table">
                ...
                <ul>
                    ...
                    <li>
                        <a href="#2-3">2.3 留言及评价涉及以下内容将无法获得公开展示</a>
                    </li>
                    <li>
            ...
            <div class="details">
                <div id="2" class="item">
                    ...
                    <h5>2.1 总则</h5>
                    <ol>
                        <li>为保证《领导留言板》的有序运营，请您务必仔细阅读并充分理解协议内容，这是您使用《领导留言板》的先决条件。您的下载、安装、使用、注册、登录行为都将会被视为同意本协议的全部内容。本协议依据国家有关法律、法规及相关管理机构章程制定。</li>
                        <li><b>《领导留言板》为您搭建与领导沟通的桥梁，不干涉双方沟通结果。《领导留言板》会积极携手各方更好地解决问题，但作为非主管部门，《领导留言板》无法保证您的留言一定能获得公开展示（有关留言能否展示可参阅“2.3留言及评价涉及以下内容将无法获得公开展示”），也不保证您的留言能获得回复，亦不保证您的诉求一定能获得解决。</b></li>
                        <li>2.1.1 《领导留言板》给您的通知仅作为一种信息提醒或建议。</li>
                        <li>2.1.2 《领导留言板》有权按照相关法律法规、相关管理部门的要求，以及本平台的编辑方针，针对包括但不限于留言、评价、回复等的全部内容进行审查、处理。</li>
                        <li>2.1.3 留言的回复内容由机构用户发布。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="2-2"></a>
                    ...
                    <ol>
                        ...
                        <li>2.2.3 普通用户和企业用户可使用如下服务：在本平台相关地方板块或部委板块内发表并分享留言；对其它网友留言进行关注；对“官方给我的回复”进行评价。机构用户可进行留言办理和回复。</li>
                        <li>2.2.4 用户在《领导留言板》所进行的所有活动应遵守中华人民共和国法律法规，遵守人民网相关管理制度，遵守本平台的管理条例。<b>为了建立健康的网络交流环境，用户需遵守网络道德，注意网络礼仪，做到文明上网。请依法、据实发布信息，不要填写虚假信息。不得捏造事实、诬陷诽谤他人、泄露他人隐私。</b></li>
                        ...
                        <li><b>2.2.5 用户在《领导留言板》发布的一切内容（包含但不限于通过《领导留言板》目前各产品功能如留言、评价、回复等）仅代表用户个人观点，不视为人民网或《领导留言板》赞同其内容之观点或证明其内容的真实性。因用户在《领导留言板》内发布内容所产生的纠纷由用户负责处理，产生的法律责任由用户承担，该责任包括但不限于给人民网及其他第三方（个人、法人及非法人组织）造成的直接或间接法律责任。</b>在法律允许的范围内，人民网和《领导留言板》对上述内容予以免责。</li>
                        <li>2.2.6 用户要注意保管好已注册登记的用户名及密码，如用户发现账号遭他人非法使用，应立即通知《领导留言板》管理员。因黑客行为或用户自身原因导致账号、密码遭他人非法使用，人民网不承担任何责任。</li>
                        <li>2.2.7 如用户认为自己在《领导留言板》的权益受到侵害，有权根据《领导留言板》相关规定进行投诉申诉。</li>
                        <li>2.2.8 用户有权对《领导留言板》的管理提出批评、意见、建议。</li>
                        <a name="2-2-9"></a>
                        <li>2.2.9 用户可发布一定数量的留言。</li>
                        <li>2.2.10 除非本协议另有其它明示规定，人民网及本平台增加或强化目前本服务的任何新功能，包括所推出的新产品，均受本使用协议之规范。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="2-3"></a>
                    <h5>2.3 留言及评价涉及以下内容将无法获得公开展示</h5>
                    <ol>
                        ...
                        <li>2.3.21 缺乏理性讨论诚意、无理纠缠、恶意灌水等浪费版面资源的；重复留言，测试留言；过于私人化的聊天、灌水、无意义刷屏的；含有引战行为或过于偏激的主观判断的；含有激进时政、意识形态方面的内容的；</li>
                        <li>2.3.22 用户在留言中表示不愿意公开展示，或不愿意让第三方知晓的；</li>
                        <li>2.3.23 冒充其他任何人或机构，或以虚伪不实的方式陈述或谎称与任何人或机构有关的；有意模仿或冒充他人注册名或冒充本平台管理人员发布信息的；</li>
                        <li>2.3.24 破坏留言板秩序，侵害本平台及人民网利益的；滥用产品功能的；破坏本平台生态及氛围的；发布与《领导留言板》主旨无关内容的；</li>
                        <li>2.3.25 未经同意，张贴任何形式的广告；</li>
                        <li>2.3.26 在留言的标题和内容中加入各种特殊符号的；</li>
                        <li>2.3.27 在留言（包括但不限于标题、正文、附件等）中加入如下符号组合：ASIIC码、区位码字符、汉字空字符、汉字全角字符、键盘上位字符（由按SHIFT引出的符号）等字符；</li>
                        <li><b>2.3.28 同一账号短时间内连续多次留言，并造成版面被同一账号的留言大面积冲击等恶意行为；不同账号短时间内连续多次就同一事项留言，并造成版面被反映同一事项的留言大面积冲击等行为；</b></li>
                        <li>2.3.29 留言事项应一事一单，请勿就同一事项重复留言，请勿在一条留言中对不同主体提出诉求。</li>
                        <li>2.3.30 申请政府信息公开的；申请行政复议的；申请行政诉讼的；申请立案的；申请执行的；</li>
                        <li>2.3.31 留言内容与用户所选择的板块、话题、类型等不匹配的；留言内容不属于用户所选择的相关板块办理单位职责范围内的；</li>
                ...
                <div class="item">
                    ...
                    <ol>
                        ...
                        <li>2.4.9 对于和其他用户笔名名称相近的笔名并可能引起争执的，《领导留言板》将支持先注册的笔名用户，而保留取消后注册笔名用户的权利；</li>
                        <li>2.4.10 对于严重违反《领导留言板》规则的，人民网保留随时取消其笔名的权力；</li>
                        <li>2.4.11 笔名一旦注册不能更改；</li>
                        <li>2.4.12 用户需对自己的笔名和密码安全负责，如遗失密码或遗忘用户名，可通过《领导留言板》“找回密码”功能重新获得密码。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="2-5"></a>
                    <h5>2.5 注销账号</h5>
                    <ol>
                        <li>您可先登录《领导留言板》客户端，点击“我的”，点击页面右上角“设置”，选择“账号与安全”，点击“注销账号”，并按照相关步骤进行操作。</li>
                        <li>在您注销您的《领导留言板》账号之前，请您充分阅读、理解并同意下列事项： </li>
                        <li>2.5.1 您所申请注销的账号应当是您本人依照《领导留言板》产品《用户服务协议》的约定注册的账号。您应当依照产品提示进行账号注销。</li>
                        ...
                        <li>2.5.3 《领导留言板》产品账号注销将导致《领导留言板》产品《用户服务协议》及相关规则约定的双方的权利义务终止（依本协议其他条款另行约定不得终止的或依其性质不能终止的除外），同时还可能对于该账号产生如下结果，且均由您自行承担：</li>
                        ...
                        <li style="margin-left: 1rem;">D.您通过领导留言板产品账号使用、授权登录或绑定该账号后使用的任何第三方的其他服务，您将无法通过该账号再登录、使用或继续使用前述第三方服务，所有记录将无法找回。</li>
                        <li>2.5.4 您同意在您申请注销账号期间或注销后，如果您的账号涉及或可能涉及争议、纠纷，包括但不限于投诉、举报、诉讼、仲裁、国家有权机关调查等，本平台有权自行中止或终止您的账号注销申请而无需另行得到您的同意；另，注销您的《领导留言板》账号并不代表该账号注销前的账号行为和相关责任得到豁免或减轻。</li>
                        <li>2.5.5 如您在《领导留言板》账号注销过程中有任何问题，您无法处理的，或在处理过程中有任何疑惑的，可联系《领导留言板》协助处理。</li>
                    </ol>
                </div>
                <div class="item">
                    <a name="2-6"></a>
                    <h5>2.6 隐私权保护</h5>
                    <ol>
                        <li>2.6.1 保护您个人信息安全既是法律要求，也是人民网长期坚持的一项基本原则。您使用或继续使用我们的服务，即意味着同意我们按照《人民网个人信息保护政策》及《领导留言板》的相关服务协议，收集、使用、储存和透露您的相关信息。详细内容请见
                            <a href="javascript:void(0)" onclick="showmen(9)">《&lt领导留言板&gt隐私政策》</a>。</li>
                        <li>2.6.2 《领导留言板》同时保护用户本人及留言中涉及的当事人的隐私权和其他合法权益，建议用户勿在留言、评价、回复的公开区域发布当事人的各种信息。如为办理核实需要，文字内容请放置在留言的备注区内，图片、视频、位置定位等请选择“不公开”。 </li>
                    </ol>
                </div>
                <div class="item">
                    <a name="2-7"></a>
                    <h5>2.7 版权声明</h5>
                    <ol>
                        <li>2.7.1 用户在《领导留言板》发表的文字内容、图片、视频仅代表用户本人观点，文责自负。</li>
                        <li>2.7.2 转帖文章，请注明文章原始出处和发布时间，并注意原作者的版权声明，由此产生的版权纠纷由转帖用户承担。</li>
                        <li>2.7.3 《领导留言板》提供的网络服务中包含的标识、版面设计、排版方式、文本、图片、图形等均受著作权、商标权及其它法律保护，未经相关权利人（含《领导留言板》及其他原始权利人）同意，上述内容均不得在任何平台被直接或间接发布、使用、出于发布或使用目的地改写或再发行，或被用于其他任何商业目的。</li>
                        <li>2.7.4 《领导留言板》有权将栏目内发表的文章或图片/视频（附带版权声明除外）自行或与他人合作使用，包括但不限于网站、电子杂志、平面出版等。用于平面出版等商业性用途时，将按同行业的稿费标准支付稿酬并于使用前通知留言作者。</li>
                        <li>2.7.5《领导留言板》内的文章及图片/视频（包括转帖的文章及图片/视频）版权仅归原作者所有，若作者有版权声明或原文章从其它网站转载而附带有原版权声明者，其版权归属以附带声明为准；因用户发表在《领导留言板》上的文章及图片/视频产生的法律责任由用户承担，该责任包括但不限于侵犯文章或图片/视频原作者或第三人的著作权、人身权所导致的民事责任，以及遭受行政机关处罚所导致的行政责任。</li>
                        <li>2.7.6《领导留言板》根据版面管理需要有权删除转帖；</li>
                        <li>2.7.7 任何转载、引用发表于《领导留言板》的版权文章须符合以下规范：</li>
                        <li style="margin-left: 1rem;">（1）征得文章或图片/视频原作者同意，注明作者文章及图片/视频的出处为人民网《领导留言板》（liuyan.people.com.cn）或人民网《领导留言板》的某地分板。如用于商业性用途，需向作者支付稿酬。</li>
                ...
                <div class="item">
                    ...
                    <h5>2.8 免责声明</h5>
                    <ol>
                        <li>2.8.1 用户于本平台发布的一切内容（包含但不限于通过《领导留言板》目前各产品功能，如留言、评价、回复等发布的内容）仅代表用户个人观点，不视为人民网和《领导留言板》赞同其内容之观点或证明其内容的真实性。作为内容的发布者，需对所发布内容负责，因所发布内容引发的一切纠纷，由该内容的发布者承担全部法律责任。在法律允许的范围内，人民网和《领导留言板》对上述内容予以免责。</li>
                        <li>2.8.2 《领导留言板》用户之间通过栏目相识、交往，留言办理过程中所发生或可能发生的任何心理、生理上的伤害和经济上的损失，人民网不承担任何责任。</li>
                        <li>2.8.3 留言（或评价）中含有违反法律法规、违反服务协议和管理部门要求的，用户未提供相关证明材料可能会对第三方（包括但不限于个人、法人及非法人组织）造成侵权的，含有不适合公开展示内容的，《领导留言板》有权对相关内容不公开展示。</li>
                        <li>2.8.4 个人、法人及非法人组织（以下简称“投诉人”）如认为本平台上存在侵犯自身合法权益的内容，应依照法律规定向《领导留言板》发出通知，并提供有法律效力的证明材料。《领导留言板》将依照投诉人通知内容以及现行法律规定对涉嫌侵权内容进行处理。<b>《领导留言板》依法处理相关内容，即视为履行完毕相关法律义务，不再对涉嫌侵权内容承担任何法律责任。出现《领导留言板》已经删除或处理的内容，但是搜索引擎依然可以搜索到的现象，是因为搜索引擎自带缓存，此类问题人民网及《领导留言板》无权也无法处理，您可以自行联系搜索引擎服务商进行处理。</b></li>
                        <li>2.8.5 用户因其自身原因（包括但不限于用户自行将当事人信息发布在公开展示区、其个人资料保管不当等）而导致个人隐私被泄露的，或引起任何其他心理、生理上的伤害或经济上的损失的，人民网及《领导留言板》不承担任何责任。</li>
                        <li>2.8.6 《领导留言板》各项服务不一定能满足用户的所有需求。</li>
                        ...
                        <li>2.8.8 由于非故意或不可抗力等原因（含系统维护和升级、网络故障），导致用户数据丢失、服务的中断、服务的延迟、服务的暂停或停止、服务的安全性等问题，人民网及《领导留言板》不承担赔偿及其他连带法律责任，但将尽力减少因此而给用户造成的损失和影响。</li>
                        <li>2.8.9 《领导留言板》不保证为用户便利而提供的外部链接的准确性和完整性，同时，对于该外部链接指向的不由人民网实际控制的任何网页上的内容，人民网及《领导留言板》不承担任何责任。</li>
                        <li>2.8.10 《领导留言板》给用户的通知（包括但不限于信息展示状态变更、留言状态变更等）仅作为一种信息提醒或建议，不具有法定效力，不能作为用户提起信访和/或诉讼的依据。具体业务办理以相关法律法规为准。</li>
                ...
                <div class="item">
                    ...
                    <ol>
                        <li>2.9.1 违反《领导留言板》用户协议及管理条例的留言、评价，管理员有权直接删改，无需通知用户。</li>
                        <li>2.9.2 违反《领导留言板》用户协议及管理条例的用户，管理员有权删除相关内容并对该用户采取警告、屏蔽用户发言权直至取消用户会员资格的处理。</li>
                        <li>2.9.3 严重违反《领导留言板》服务协议的，管理员有权封禁用户IP和账号。</li>
                ...
                <div class="item">
                    ...
                    <h5>2.10 协议修改</h5>
                    <ol>
                        <li>2.10.1 随着互联网的发展和有关法律、法规及规范性文件的变化，或者因业务发展需要，《领导留言板》有权对本协议的条款作出修改或变更，一旦本协议的内容发生变动，《领导留言板》将会直接在《领导留言板》网站上公布修改之后的协议内容，该公布行为视为《领导留言板》已经通知用户修改内容。《领导留言板》也可采用站内通知、短信、电子邮件或私信传送方式，提示用户协议条款的修改、服务变更，或其它重要事项。</li>
                        <li>2.10.2 如果不同意《领导留言板》对本协议相关条款所做的修改，用户有权并应当停止使用《领导留言板》。如果用户继续使用《领导留言板》，则视为用户接受《领导留言板》对本协议相关条款所做的修改。</li>
                    </ol>
                </div>
            </div>
        </div>
