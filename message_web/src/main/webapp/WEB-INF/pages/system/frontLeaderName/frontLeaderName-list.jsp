...
<script>
    function deleteById() {
        ...
        if(id) {
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="${ctx}/system/frontLeaderName/delete.do?id="+id;
            }
        }else{
    ...
    function roleList() {
        var id = getCheckId()
        if(id) {
            location.href="${ctx}/system/frontLeaderName/roleList.do?id="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
    ...
    <div class="box box-primary">
        ...
        <div class="box-footer">
            <jsp:include page="../../common/page.jsp">
                <jsp:param value="${ctx}/system/frontLeaderName/list.do" name="pageUrl"/>
            </jsp:include>
        </div>
    </div>
