            ...
            <div class="table-box">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default" title="待回复" onclick='location.href="${ctx}/cargo/thank/unlist.do?typeId=9"'><i class="fa fa-file-o"></i> 待回复</button>
                            <button type="button" class="btn btn-default" title="已回复" onclick='location.href="${ctx}/cargo/thank/allist.do?typeId=9"'><i class="fa fa-file-o"></i> 已回复</button>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr>
                            ...
                            <td>${o.passage}......</td>
                            <td>
                                <a href="${ctx }/cargo/thank/toUpdate.do?id=${o.id}">[查看详情]</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
