...
@Controller
@RequestMapping("/cargo/complaint")
public class ComplaintController extends BaseController {
    ...
    public String unlist(@RequestParam(defaultValue = "1",required = false) int page,
        ...
        return "cargo/complaint/complaint-list";
    }
    ...
    public String toUpdate(Long id) {
        ...
        return "cargo/complaint/complaint-update";
    }
    ...
    public String edit(Long id,String responsePassage) {
        ...
        return  "redirect:/cargo/complaint/unlist.do?typeId=2";
    }
}
